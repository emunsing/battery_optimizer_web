...
def get_or_cache_weather_data(latitude: float, longitude: float, start_yr: int, end_yr: int, timezone: str,
                              surface_tilt:float | None=None, surface_azimuth:float=180) -> pd.Series:
